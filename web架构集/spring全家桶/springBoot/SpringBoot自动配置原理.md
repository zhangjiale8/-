...
## 1.1 SpringBoot启动的时候加载主配置类，开启了自动配置功能@EnableAutoConfiguration

## 1.2 @EnableAutoConfiguration 作用：

利用Enable AutoConfigurationImportSelector给容器中导入一些组件；
...
## 1.5 所有在配置文件中能配置的属性都是在xxxxProperties类中封装者‘；配置文件能配置什么就可以参照某个功能对应的这个属性类

![preview](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\v2-1b2862c5c53ea2fdee7031005a533284_r.jpg)
...
![preview](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\v2-e6e9399fd6c989bf2e9932f24067a560_r.jpg)
