...
以前我们需要配置的东西，Spring Boot帮我们自动配置；@EnableAutoconfiguration 告诉SpringBoot开启自 动配置功能；这样自动配置才能生效； 
...
* @Import(AutoconfigurationPackages.Registrar.class)： Spring的底层注解@Import，给容器中导入一个组件；导入的组件AutoconfigurationPackages.Registrar.class； 
...
#### 2.8.2.1 @Conditional派生注解（Spring注解版原生的@Conditional作用）
...
![image-20201029183539284](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201029183539284.png)
...
统一日志记录，即使是别的框架和我一起统一使用slf4j进行输出？如何让系统中所有的日志都统一到slf4j；

![image-20201029184037044](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201029184037044.png)

#### 3.2.2.1 如何让系统中所有的日志都统一到slf4j；
...
![image-20201029184419913](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201029184419913.png)
...
![image-20201029184654452](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201029184654452.png)
...
![image-20201029192558471](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201029192558471.png)
...
![image-20201103084151067](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103084151067.png)
...
#### 4.3.2.1 导入thymeleaf的名称空间

```html
<html lang="en" xmlns:th="http://www.thymeleaf.org">
```

#### 4.3.2.2 使用thymeleaf语法； 
...
#### 4.3.3.1 th:text；改变当前元素里面的文本内容； 

th：任意html属性；来替换原生属性的值 

![image-20201103084721785](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103084721785.png)
...
you can declare a WebMvcRegistrationsAdapter instance providing such components. If you want to take complete control of Spring MVC, you can add your own @Configuration annotated with @EnableWebMvc .
```
...
![image-20201103092309407](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103092309407.png)
...
![image-20201103092514698](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103092514698.png)
...
![image-20201103102755626](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103102755626.png)

浏览器发送请求的请求头：

![image-20201103102853837](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103102853837.png) 

* 如果是其他客户端，默认响应一个json数据 

![image-20201103102935437](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103102935437.png)

![image-20201103103006741](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103103006741.png)
...
最终的效果：响应是自适应的，可以通过定制ErrorAttributes改变需要返回的内容，
 ...
 ![image-20201103104651615](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103104651615.png)

## 4.8 配置嵌入式Servlet容器

SpringBoot默认使用Tomcat作为嵌入式的Servlet容器； 

![image-20201103104803902](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103104803902.png)
...
### 4.8.2 注册Servlet三大组件【Servlet、Filter、Listener】
...
![image-20201103105838455](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103105838455.png)
...
![image-20201103112235468](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103112235468.png)

* EmbeddedServletContainer：（嵌入式的Servlet容器） 

![image-20201103112323811](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103112323811.png)
...
* refreshContext(context);SpringBoot刷新IOC容器【创建IOC容器对象，并初始化容器，创建容器中的每一 个组件】；如果是web应用创建**AnnotationconfigEmbeddedWebApplicationContext**，否则： **AnnotationconfigApplicationContext** 
...
EmbeddedServletContainerFactory containerFactory = getEmbeddedServletContainerFactory(); 从ioc容器中获取EmbeddedServletContainerFactory 组件；**TomcatEmbeddedServletContainerFactory**创建 对象，后置处理器一看是这个对象，就获取所有的定制器来先定制Servlet容器的相关配置； 
...
* SpringServletContainerInitializer将@HandlesTypes(WebApplicationInitializer.class)标注的所有这个类型 的类都传入到onStartup方法的Set>；为这些WebApplicationInitializer类型的类创建实例； 

* 每一个WebApplicationInitializer都调用自己的onStartup； 

![image-20201103131805628](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103131805628.png)
...
![image-20201103135426088](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103135426088.png)

![image-20201103135453769](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103135453769.png)
...
![image-20201103135726830](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103135726830.png)
...
![image-20201103150304037](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103150304037.png)
...
![image-20201103151103147](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103151103147.png)
...
![image-20201103155447260](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103155447260.png)

![image-20201103155514523](E:\学习笔记\mylearnnote\web架构集\spring全家桶\springBoot\image\image-20201103155514523.png)
...
public class HelloCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        System.out.println("CommandLineRunner...run..."+ Arrays.asList(args));java
    }
}
```
